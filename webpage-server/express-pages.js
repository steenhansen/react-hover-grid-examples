...
let web_server = function (public_static_files, localhost_port) {
  ...
  express_server.get("/", function (req, res) {
    //  all => show_all
    require("./page-all")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/circle-clip", function (req, res) {
    require("./page-circle")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/npm-example", function (req, res) {
    require("./page-npm")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/readme-sample", function (req, res) {
    require("./page-readme")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/shrink-grow", function (req, res) {
    require("./page-shrink")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/resizable-splitter", function (req, res) {
    require("./page-resize")(req, res, HTML_DIR, IMAGES_DIR);
  });

  express_server.get("/ssr-no-js", function (req, res) {
    require("./page-nojs")(req, res, HTML_DIR, IMAGES_DIR);
  });
