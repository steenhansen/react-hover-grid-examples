...
var sizeable_grid_HoverGrid = ReactDOM.render(_react2.default.createElement('div', null, _react2.default.createElement(_reactSplitPane2.default, {
    split: 'vertical',
    defaultSize: LEFT_PANE_SIZE,
    minSize: 50,
    maxSize: -75,
    onChange: sizeable_resizePubSub_splitter.publishWidthChange
}, _react2.default.createElement('div', { id: sizeable_left_grid_id }, _react2.default.createElement(_reactHoverGrid2.default, sizeable_grid_left_data)), _react2.default.createElement('div', {
    id: sizeable_right_grid_id,
    style: { marginLeft: '20px' }
}, _react2.default.createElement(_reactHoverGrid2.default, sizeable_grid_right_data)))), document.getElementById('sizeable_grid_id'));
