  ...
  return Promise.all(events_promises)
      ...
      const sizeable_grid_html = `
              ...
              <html lang="en-US">
                ...
                <body>
                  <br>
                  <div id='sizeable_grid_id' style='width:100px; margin:0 auto; height:444px'>&nbsp;</div>
                  ${react_includes}
      ...
      res.flushHeaders()    
      var sizeable_minified = jsx_chunks.minify_html(sizeable_grid_html, process.env.NODE_ENV)
