...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "" + {"0":"4c2ce48cb3dad7a00219","1":"c2f88028225242b4c21b","2":"e48832fe32eb1cdc9ea5","3":"17fb1fded12fccfe9b03","4":"1710fb652748d1ef476c"}[chunkId] + ".js";
...
var baseRandom = __webpack_require__(43);
...
var _PictureTile = __webpack_require__(37);
...
var _ScreenSizeToGrid = __webpack_require__(39);

var _ScreenSizeToGrid2 = _interopRequireDefault(_ScreenSizeToGrid);

var _miscFuncs = __webpack_require__(20);
...
var lodash_shuffle = __webpack_require__(40);
var invariant = __webpack_require__(19);
  ...
  _createClass(ReactHoverGrid, [{
    ...
    value: function _serverRenderCheck() {
      if (this.props.server_render) {
        !(typeof this.props.server_screen_size !== 'undefined') ?  true ? invariant(false, 'ReactHoverGrid must have a server_screen_size property if server_render') : invariant(false) : void 0;
        !Array.isArray(this.props.server_screen_size) ?  true ? invariant(false, 'ReactHoverGrid, server_screen_size must be an array if server_render, it is a ' + _typeof(this.props.server_screen_size)) : invariant(false) : void 0;
        !(this.props.server_screen_size.length > 0) ?  true ? invariant(false, 'ReactHoverGrid must have an un-empty server_screen_size property if server_render') : invariant(false) : void 0;

        !(typeof this.props.server_grid_size !== 'undefined') ?  true ? invariant(false, 'ReactHoverGrid must have a server_grid_size property if server_render') : invariant(false) : void 0;
        !Array.isArray(this.props.server_grid_size) ?  true ? invariant(false, 'ReactHoverGrid, server_grid_size must be an array if server_render, it is a ' + _typeof(this.props.server_grid_size)) : invariant(false) : void 0;
        !(this.props.server_grid_size.length > 0) ?  true ? invariant(false, 'ReactHoverGrid must have an un-empty server_grid_size property if server_render') : invariant(false) : void 0;
...
var _StyleOrJsx = __webpack_require__(38);
...
var PictureTile = function (_Component) {
  ...
  _createClass(PictureTile, [{
    ...
    value: function _imageSource(image_type) {
      var image_folder = this.props.hover_grid_id.replace('_id', '_images');
  ...
  function PictureTile(props) {
    ...
    if (_this.props.ssr_grid_id) {
      _this.css_grid_id = _this.props.ssr_grid_id; // N.B. use short version 's' of 's_grid_id' for css
    } else {
      _this.css_grid_id = _this.props.hover_grid_id; // N.B. use long version 'my_dogs_grid_id' for css
    }
    var link_url = _this._imageUrl();
  ...
  _createClass(PictureTile, [{
    ...
    value: function _normalImage() {
      var image_id = this.class_id_names['IMAGE_ID'] + this.props.picture_container_id;
      var image_src = this._imageSource(TILE_SIZED_IMAGES);
      var image_styles = new _StyleOrJsx2.default('', { width: this.props.picture_width, cursor: 'pointer' });
    ...
    value: function _imageTile() {
      ...
      return _react2.default.createElement(
        'div',
        { className: normal_classNames, style: normal_jsx_styles },
    ...
    value: function _showHideCss() {
      var picture_container_id = this.props.picture_container_id;
      var hover_show_id = picture_container_id + this.class_id_names['HOVER_TEXT_POSTFIX'];
      var before_show_id = picture_container_id + this.class_id_names['NORMAL_TEXT_POSTFIX'];
      var normal_show_id = picture_container_id + this.class_id_names['IMAGE_POSTFIX'];
      var my_styles = ' #' + picture_container_id + ':hover #' + hover_show_id + '{opacity:1}' + (' #' + picture_container_id + ' #' + hover_show_id + '{opacity:0}') + (' #' + picture_container_id + ':hover #' + before_show_id + '{opacity:0}') + (' #' + picture_container_id + ' #' + before_show_id + '{opacity:1}') + (' #' + picture_container_id + ':hover #' + normal_show_id + '{opacity:0}') + (' #' + picture_container_id + ' #' + normal_show_id + '{opacity:1} ');
    ...
    value: function render() {
      ...
      var mouse_hover_text = this._hoverText(this.props.picture_container_id + this.class_id_names['HOVER_TEXT_POSTFIX']);
      var plain_text = this._plainText(this.props.picture_container_id + this.class_id_names['NORMAL_TEXT_POSTFIX']);
      var image_tile = this._imageTile(this.props.picture_container_id + this.class_id_names['IMAGE_POSTFIX']);
      var tile_container_class = this.class_id_names['TILE_CONTAINER_PF'];
      var my_styles = this._showHideCss();
      var image_url = this.state.link_url;
      return _react2.default.createElement(
        'div',
...
PictureTile.BASE_TILE_SHAPE = _propTypes2.default.shape({
  ...
  picture_width: _propTypes2.default.number,
...
PictureTile.propTypes = {
  picture_container_id: _propTypes2.default.string.isRequired,
  setHoverFunction: _propTypes2.default.func.isRequired,
  hover_grid_id: _propTypes2.default.string.isRequired,
  ssr_grid_id: _propTypes2.default.string,
  ...
  normal_text_style: _propTypes2.default.oneOfType(PictureTile.STRING_OR_OBJECT_CSS),
  hover_title_style: _propTypes2.default.oneOfType(PictureTile.STRING_OR_OBJECT_CSS),
  hover_text_style: _propTypes2.default.oneOfType(PictureTile.STRING_OR_OBJECT_CSS),

  filter_normal: _propTypes2.default.string,
  filter_hover: _propTypes2.default.string,
  adjusted_tile_width: _propTypes2.default.number.isRequired,
  picture_width: _propTypes2.default.number.isRequired,
  left_picture_margin: _propTypes2.default.number.isRequired,
  picture_src: _propTypes2.default.string.isRequired,
...
var arrayShuffle = __webpack_require__(41),
    baseShuffle = __webpack_require__(44),
...
var copyArray = __webpack_require__(42),
